...
Pythinker only loads the relevant reference file when needed.
...
5. Deliver the skill (send SKILL.md path via skill_create tool)
...
Use `skill_create` tool to create and deliver the skill. The system will automatically:

1. Detect the skill structure
