...
- Use SEQUENTIAL citation numbering starting from [1] — cite sources in the order they first appear in your text (e.g. [1], [2], [3], not [1], [5], [21]).""")
    ...
    if has_sources and source_list:
        ...
        if source_count > 0:
            parts.append(
                ...
                f"\nExample of CORRECT sequential citation usage:\n"
                f'"FastAPI uses Starlette for routing [1] and Pydantic for validation [2].\n'
                f'Django provides an ORM [3] and admin interface [3][4]."\n'
                f"Notice: [1], [2], [3], [4] — sequential, no gaps.\n"
            )
