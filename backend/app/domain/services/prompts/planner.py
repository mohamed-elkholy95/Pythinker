...
UPDATE_PLAN_PROMPT = """Return the remaining uncompleted steps as JSON.
...
{{"steps": [{{"id": "3", "description": "Validate results and deliver final report"}}]}}

Example — two steps remaining:
{{"steps": [{{"id": "4", "description": "Cross-validate findings"}}, {{"id": "5", "description": "Compile and deliver report"}}]}}

Example — task fully complete:
{{"steps": []}}
"""
