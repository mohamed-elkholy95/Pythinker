...
async def run_gateway() -> None:
    ...
    gateway = NanobotGateway(
        ...
        telegram_webhook_mode=settings.telegram_webhook_mode,
        telegram_webhook_url=settings.telegram_webhook_url,
        telegram_webhook_secret=settings.telegram_webhook_secret,
        telegram_webhook_path=settings.telegram_webhook_path,
        telegram_webhook_host=settings.telegram_webhook_host,
        telegram_webhook_port=settings.telegram_webhook_port,
        telegram_proxy_url=settings.telegram_proxy_url,
        telegram_reaction_notifications=settings.telegram_reaction_notifications,
        telegram_dm_policy=settings.telegram_dm_policy,
        telegram_group_policy=settings.telegram_group_policy,
        telegram_group_require_mention=settings.telegram_group_require_mention,
        telegram_group_allowed=settings.telegram_group_allowed_users or None,
        telegram_groups=settings.telegram_groups,
        telegram_direct=settings.telegram_direct,
        ...
        telegram_inline_buttons_scope=settings.telegram_inline_buttons_scope,
