...
class TestManusAgentFactory:
    """Test suite for ManusAgentFactory."""
...
class TestManusAgentFactoryIntegration:
    """Integration tests for ManusAgentFactory with real components."""
