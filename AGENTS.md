...
- **Context7 MCP source priority (always)**: for library/API documentation, setup, configuration, and implementation lookup tasks, use `Context7` MCP first. If Context7 does not cover the need, fall back to official/primary web sources for verification and broader research.
