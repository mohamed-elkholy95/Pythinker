  ...
  <div class="flex-1 min-h-0 w-full flex flex-col">
    ...
    <div v-else :class="resultContainerClass">
      ...
      <div v-else class="chart-preview-container rounded-lg overflow-hidden border border-[var(--border-main)] bg-white dark:bg-[var(--code-block-bg)] mb-4">
        <img v-if="pngUrl && !pngLoadError" :src="pngUrl" :alt="displayTitle || 'Chart'" class="w-full h-auto object-contain cursor-pointer hover:opacity-90 transition-opacity" @click="emit('open-canvas')" @error="onPngError" />
