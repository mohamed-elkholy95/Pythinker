<template>
  <div class="skills-settings">
    ...
    <div v-if="!loadingCustom" class="custom-skills-section">
      <!-- Empty State -->
    ...
    <div v-if="deletingSkill" class="confirm-overlay" @click.self="deletingSkill = null">
      <div class="confirm-dialog">
        ...
        <div class="confirm-actions">
          ...
          <button @click="handleDeleteSkill" class="btn-danger" :disabled="loadingMutation">
            {{ loadingMutation ? 'Deleting...' : 'Delete Skill' }}
          </button>
        </div>
      </div>
    </div>
    ...
    <div v-if="publishingSkill" class="confirm-overlay" @click.self="publishingSkill = null">
      <div class="confirm-dialog">
        ...
        <div class="confirm-actions">
          ...
          <button @click="handlePublishSkill" class="btn-primary" :disabled="loadingMutation">
            {{ loadingMutation ? 'Publishing...' : 'Publish Skill' }}
          </button>
        </div>
      </div>
    </div>
...
.add-dropdown-menu {
  ...
  border-radius: 14px;
  box-shadow: 0 10px 28px var(--shadow-M);
  z-index: 100;
  overflow: hidden;
