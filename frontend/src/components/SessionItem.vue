<template>
  <div class="px-2">
    <div @click="handleSessionClick"
      class="group flex h-10 cursor-pointer items-center gap-3 rounded-lg px-2 transition-colors"
      ...
      <div @click="handleSessionMenuClick"
        class="w-6 h-6 flex-shrink-0 rounded-md flex items-center justify-center cursor-pointer opacity-0 group-hover:opacity-100 hover:bg-[var(--fill-tsp-gray-dark)] transition-opacity"
