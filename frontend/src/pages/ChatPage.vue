      ...
      >
        ...
        >
          <ChatMessage v-for="(message, index) in messages" :key="message.id" :message="message"
            ...
            :activeReasoningState="!isChatMode && !showPlanningCard && message.id === activeAssistantMessageId ? activeReasoningState : undefined"
            :thinkingText="message.id === activeAssistantMessageId ? thinkingText : undefined"
            :liveActivity="!isChatMode && !showPlanningCard && message.id === activeAssistantMessageId ? liveActivity : undefined"
