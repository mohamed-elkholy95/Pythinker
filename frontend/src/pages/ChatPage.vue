      ...
      >
        ...
        >
          <ChatMessage v-for="(message, index) in messages" :key="message.id" :message="message"
            ...
            :activeReasoningState="!isChatMode && !isSessionComplete && !showPlanningCard && message.id === activeAssistantMessageId ? activeReasoningState : undefined"
            :thinkingText="message.id === activeAssistantMessageId ? thinkingText : undefined"
            :liveActivity="!isChatMode && !isSessionComplete && !showPlanningCard && message.id === activeAssistantMessageId ? liveActivity : undefined"
