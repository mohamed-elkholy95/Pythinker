...
# Stable runtime dir for Chromium in restricted containers.
...
# Create /run/user/1000 for Chromium runtime sockets.
...
su -s /bin/sh ubuntu -c "mkdir -p /home/ubuntu/.cache /home/ubuntu/.config"
su -s /bin/sh ubuntu -c "chmod 700 /home/ubuntu/.cache"
