...
Tier 3: xwd + ImageMagick (legacy, ~100ms) - X11 screenshot with convert binary
...
# ---------------------------------------------------------------------------
# XWD + ImageMagick capture (Tier 3) - legacy fallback
# ---------------------------------------------------------------------------
...
async def capture_screenshot(
    ...
    3. xwd + ImageMagick convert - legacy pipeline (~100ms)
