...
class WorkspaceConfig(BaseModel):
    ...
    template: WorkspaceTemplate = Field(default=WorkspaceTemplate.NONE, description="Workspace template used")
    created_at: str = Field(..., description="Creation timestamp")
    python_version: Optional[str] = Field(None, description="Python version if applicable")
    node_version: Optional[str] = Field(None, description="Node.js version if applicable")
...
class WorkspaceInitResult(BaseModel):
    ...
    directories_created: List[str] = Field(default_factory=list, description="List of created directories")
...
class DirectoryEntry(BaseModel):
    ...
    children: Optional[List["DirectoryEntry"]] = Field(None, description="Child entries (for directories)")
