        ...
        result.append(
            {
                ...
                "tokens_by_model": {
                    "claude-sonnet-4-20250514": int(50000 * multiplier),
                    "claude-haiku-4-5-20251001": int(7000 * multiplier),
                },
                "cost_by_model": {
                    "claude-sonnet-4-20250514": round(0.72 * multiplier, 4),
                    "claude-haiku-4-5-20251001": round(0.13 * multiplier, 4),
                },
            }
        )
    return result
        ...
        result.append(
            {
                ...
                "cost_by_model": {
                    "claude-sonnet-4-20250514": round(18.50 * multiplier, 2),
                    "claude-haiku-4-5-20251001": round(3.90 * multiplier, 2),
                },
            }
        )
