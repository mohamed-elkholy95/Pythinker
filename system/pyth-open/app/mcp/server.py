...
class MCPServer:
    ...
    def __init__(self, name: str = "pythinker"):
    ...
    def run(self, transport: str = "stdio") -> None:
        ...
        logger.info(f"Starting Pythinker server ({transport} mode)")
        self.server.run(transport=transport)


def parse_args() -> argparse.Namespace:
    """Parse command line arguments."""
    parser = argparse.ArgumentParser(description="Pythinker MCP Server")
    parser.add_argument(
        "--transport",
        choices=["stdio"],
        default="stdio",
