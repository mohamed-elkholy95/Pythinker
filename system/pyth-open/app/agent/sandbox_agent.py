...
from app.prompt.pythinker import NEXT_STEP_PROMPT, SYSTEM_PROMPT
...
class SandboxPythinker(ToolCallAgent):
    """A versatile general-purpose agent with support for both local and MCP tools."""

    name: str = "SandboxPythinker"
    ...
    def initialize_helper(self) -> "SandboxPythinker":
        """Initialize basic components synchronously."""
        self.browser_context_helper = BrowserContextHelper(self)
        return self

    @classmethod
    async def create(cls, **kwargs) -> "SandboxPythinker":
        """Factory method to create and properly initialize a Pythinker instance."""
        instance = cls(**kwargs)
    ...
    async def cleanup(self):
        """Clean up Pythinker agent resources."""
